      ...
      e: for (var H = 0, G = x.length, bt = G >>> 1; H < bt; ) {
        ...
        if (0 > l(gl, z))
          gn < G && 0 > l(er, gl)
            ? ((x[H] = er), (x[gn] = z), (H = gn))
            : ((x[H] = gl), (x[yn] = z), (H = yn));
        else if (gn < G && 0 > l(er, z)) (x[H] = er), (x[gn] = z), (H = gn);
        else break e;
      }
    }
    return P;
...
function $c(e, n, t, r, l, o, u, i, s) {
  (xt = !1), (Rr = null), Fc.apply(Uc, arguments);
}
  ...
  if (!e[cr]) {
    (e[cr] = !0),
      ls.forEach(function (t) {
        t !== "selectionchange" && (Hf.has(t) || jl(t, !1, e), jl(t, !0, e));
      });
...
function hn() {
  if (!Il && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), Cs(Zo, hn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function Qr(e, n, t, r) {
  ...
  if (o !== null) {
    ...
    (Tn |= u), (e.lanes = u), (e.memoizedState = v);
  }
}
function gi(e, n, t) {
...
function ia(e) {
  ...
  function S(f, a, d, h) {
    ...
    if (L.done) return t(f, _), F && wn(f, N), E;
    if (_ === null) {
...
function pu(e, n) {
  switch ((j(Ht, n), j(Bt, e), j($e, qt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
function Ca(e, n, t) {
  return zn & 21
    ? (je(t, n) || ((t = Ps()), ($.lanes |= t), (Tn |= t), (e.baseState = !0)),
      n)
...
gs = _u;
ws = Ln;
var Td = { usingClientEntryPoint: !1, Events: [Jt, $n, ol, hs, ys, _u] },
  yt = {
...
const Hi = ({
  ...
  onCurrencyChange: r,
  currencyOptions: l = [],
  selectCurrency: o = "usd",
  amountDisabled: u = !1,
  currencyDisabled: i = !1,
  className: s = "",
}) => {
  const c = Fe.useId();
  return W.jsxs("div", {
    className: `bg-white p-3 rounded-lg text-sm flex${s}`,
    children: [
      W.jsxs("div", {
        className: "w-1/2",
        children: [
          ...
          W.jsx("input", {
            ...
            disabled: u,
            value: n,
            onChange: (m) => t && t(Number(m.target.value)),
          }),
        ],
      }),
      W.jsxs("div", {
        className: "flex flex-wrap w-1/2 justify-end text-right",
        children: [
          W.jsx("p", {
          ...
          W.jsx("select", {
            ...
            disabled: i,
            children: l.map((m) =>
              W.jsx("option", { value: m, children: m }, m)
            ),
          }),
        ],
      }),
...
function Od(e) {
  ...
  return (
    Fe.useEffect(() => {
      fetch(
        `https://cdn.jsdelivr.net/gh/fawazahmed0/currency-api@1/latest/currencies/${e}.json`
      )
        .then((r) => r.json())
        .then((r) => t(r[e]));
    }, [e]),
...
function jd() {
  ...
  return W.jsx("div", {
    className:
      "w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat",
    style: {
      backgroundImage:
        "url('https://images.unsplash.com/photo-1657581502266-929a581e4ab0?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
    },
    children: W.jsx("div", {
      className: "w-full",
      children: W.jsx("div", {
        className:
          "w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30",
          ...
          children: [
            W.jsx("div", {
              ...
              children: W.jsx(Hi, {
                ...
                amount: e,
                currencyOptions: c,
                onCurrencyChange: (p) => r(p),
                selectCurrency: t,
                onAmountChange: (p) => n(p),
              }),
            }),
            W.jsx("div", {
            ...
            W.jsxs("button", {
              ...
              children: ["Convert ", t.toUpperCase(), " to ", l.toUpperCase()],
            }),
          ],
        }),
      }),
...
Ql.createRoot(document.getElementById("root")).render(
  W.jsx(Sc.StrictMode, { children: W.jsx(jd, {}) })
);
